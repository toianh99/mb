...
public interface UserRepository extends JpaRepository<User, Long> {
   ...
   @Query("select new com.xat.core.security.dto.UserDto(u, false) from User u where u.org.id=?1")
   ...
   @Query("select new com.xat.core.security.dto.UserDto(u, false) from User u where u.username like %?1%")
   Page<UserDto> findByPageUsername(String username, Pageable pageable);

   @Query("select new com.xat.core.security.dto.UserDto(u, false) from User u where u.org.id=?1 and u.username like %?2%")
